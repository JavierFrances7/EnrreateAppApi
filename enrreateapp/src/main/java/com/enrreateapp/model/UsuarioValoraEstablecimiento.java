...
@NamedQueries({
    ...
    @NamedQuery(name = "UsuarioValoraEstablecimiento.findByUsuarioUid", query = "SELECT u FROM UsuarioValoraEstablecimiento u WHERE u.usuarioValoraEstablecimientoPK.usuarioUid = :usuarioUid"),
    @NamedQuery(name = "UsuarioValoraEstablecimiento.findByEstablecimientoUid", query = "SELECT u FROM UsuarioValoraEstablecimiento u WHERE u.usuarioValoraEstablecimientoPK.establecimientoUid = :establecimientoUid"),
...
public class UsuarioValoraEstablecimiento implements Serializable {
    ...
    @Column(name = "nota")
    private String nota;
    @JoinColumn(name = "establecimiento_uid", referencedColumnName = "uid", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Establecimiento establecimiento;
    @JoinColumn(name = "usuario_uid", referencedColumnName = "uid", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public UsuarioValoraEstablecimiento(String usuarioUid, String establecimientoUid) {
        this.usuarioValoraEstablecimientoPK = new UsuarioValoraEstablecimientoPK(usuarioUid, establecimientoUid);
    }
