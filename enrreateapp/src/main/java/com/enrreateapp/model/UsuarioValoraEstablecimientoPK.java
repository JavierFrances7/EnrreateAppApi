...
public class UsuarioValoraEstablecimientoPK implements Serializable {
    ...
    public UsuarioValoraEstablecimientoPK(String uidUsuario, String uidEstablecimiento) {
    ...
    public String toString() {
        return "com.enrreateapp.model.UsuarioValoraEstablecimientoPK[ uidUsuario=" + uidUsuario + ", uidEstablecimiento=" + uidEstablecimiento + " ]";
    }
